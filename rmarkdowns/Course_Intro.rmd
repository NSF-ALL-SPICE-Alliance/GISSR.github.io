...
Before the course starts, you will need to get all the necessary software installed and set up on your computer. Please follow the helpful instructions at this link (this was created for another course in our program, SDG Analytics in R, which I highly recommend if you enjoy this course and want to learn more): https://nsf-all-spice-alliance.github.io/GISSR.github.io/rmarkdowns/installation_guide.html

IMPORTANT NOTE: Our GitHub classroom is called GISSR-Vector, and will look a little different than what you see in the video. 
